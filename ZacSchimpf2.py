...
class Grader:
    def __init__(self) -> None:
        ...
        scores = self.get_scores(students)
        grade_scale = self.get_grade_scale(scores)
        self.__str__(scores, grade_scale)
    ...
    def get_scores(self, students) -> list:
        """
        ...
        try:
            scores = self.scores_input(students)
            scores = self.convert_to_list(students, scores)
    ...
    def scores_input(self, students) -> str:
        """
    ...
    def convert_to_list(self, students, scores_str) -> list:
        """
    ...
    def get_grade_scale(self, scores) -> None:
        """
    ...
    def __str__(self, scores, grade_scale) -> str:
        """
